...
export const PrivacyStmt =
  'Personal information is collected under the authority of the <em>Medicare Protection Act</em> ' +
...
export class CoreConsentModalComponent implements AfterViewInit {
  ...
  @ViewChild('bcpConsentModal', { static: true })
  bcpConsentModal: ConsentModalComponent;
